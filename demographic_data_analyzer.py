...
def calculate_demographic_data(print_data=True):
    ...
    higher_education = higher_education = round(df["education"].value_counts(normalize=True)[["Bachelors", "Masters", "Doctorate"]].sum()*100,1)
    lower_education = lower_education = 100 - higher_education
    ...
    earning_by_country = df.groupby("native-country")["high_salary"].mean()
    
    highest_earning_country = earning_by_country.idxmax()
    highest_earning_country_percentage = round(earning_by_country.max()*100,1)
